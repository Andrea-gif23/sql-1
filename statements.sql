...
SELECT nombre, COUNT(lenguaje) AS total_lenguajes FROM usuarios_lenguajes GROUP BY nombre;
...
SELECT COUNT(*) AS total_apellidos_g FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
...
SELECT COUNT(*) AS total_usuarios FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25;
...
SELECT COUNT(*) AS total_p FROM usuarios_lenguajes WHERE lenguaje LIKE 'P%' AND edad < 28;
